...
class GenerateMenubar:
    ...
    def generate(self) -> wx.MenuBar:
        ...
        aboutItem = fileMenu.Append(wx.ID_ABOUT, "&About OCLP-Plus")
...
class CheckProperties:
    ...
    def host_psp_version(self) -> packaging.version.Version:
        """
        Grab PatcherSupportPkg version from OCLP-Plus.plist
        """
        oclp_plist_path = "/System/Library/CoreServices/OCLP-Plus.plist"
